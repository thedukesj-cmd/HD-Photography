...
import { SiteVisitorCounter } from "@/components/site-visitor-counter"
...
export function Footer() {
  ...
  const quickLinks = [
    ...
    },
    {
      href: "/members",
      label:
        translations.nav.photographers,
      visible:
        siteConfig.navigation
          .showGuestPhotographers,
    },
    {
      href: "/news",
      label:
